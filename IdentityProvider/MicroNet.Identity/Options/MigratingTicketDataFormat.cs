...
namespace MicroNet.Identity.Options
{
    public class MigratingTicketDataFormat : ISecureDataFormat<AuthenticationTicket>
    {
        ...
        public MigratingTicketDataFormat(IHttpContextAccessor httpContextAccessor,
            CookieAuthenticationOptions options, string scheme)
        {
